            ...
            <div className="flex gap-3 flex-1">
              {activeTab === 'browse' && (
                <div className="flex items-center gap-2">
                  <label className="text-base font-bold text-gray-700 whitespace-nowrap">Show:</label>
                  <select
                    value={filterOption}
                    onChange={(e) => setFilterOption(e.target.value as 'all' | 'open' | 'registered')}
                    className="px-4 py-3 border-2 border-gray-300 rounded-xl focus:border-sky-500 focus:outline-none text-base font-semibold bg-white"
                  >
                    <option value="all">All Activities</option>
                    <option value="open">Open for Volunteer Sign-up</option>
