        ...
        <div className="p-6 space-y-6">
          <div>
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              />
              <span className="text-gray-700 font-semibold">Only show activities I'm eligible for</span>
            </label>
          </div>
            ...
            <div className="space-y-3">
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  className="w-5 h-5 text-sky-500 border-2 border-gray-300 rounded focus:ring-sky-500"
                />
                <span className="text-gray-700">Sign language support</span>
              </label>
            </div>
          </div>
          ...
          <div className="border-t border-gray-200 pt-4">
            <label className="flex items-center gap-3 cursor-pointer">
              <input
                ...
                className="w-5 h-5 text-sky-500 border-2 border-gray-300 rounded focus:ring-sky-500"
              />
              <span className="text-gray-700 font-semibold">Available slots only</span>
            </label>
          </div>

          <div className="border-t border-gray-200 pt-4">
            <h3 className="font-semibold text-gray-900 mb-3">Repeatability</h3>
            <div className="space-y-2">
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  type="radio"
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 text-sky-500 border-2 border-gray-300 focus:ring-sky-500"
                />
                <span className="text-gray-700">One-time only</span>
              </label>
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  type="radio"
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 text-sky-500 border-2 border-gray-300 focus:ring-sky-500"
                />
                <span className="text-gray-700">Recurring bi-weekly</span>
              </label>
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  type="radio"
                  ...
                  className="w-4 h-4 text-sky-500 border-2 border-gray-300 focus:ring-sky-500"
                />
                <span className="text-gray-700">Recurring monthly</span>
              </label>
            </div>
          </div>
        </div>
