...
export default function EditActivityModal({ activity, isOpen, onClose, onEditActivity }: EditActivityModalProps) {
  ...
  useEffect(() => {
    if (activity) {
      setFormData({
        ...
        repeatFrequency: activity.repeat || '',
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const updatedActivity: Activity = {
      ...
      participantCapacity: parseInt(formData.participantCapacity) || 0,
      volunteerCapacity: parseInt(formData.volunteerCapacity) || 0,
      // Preserve the current vacancy values - these would be recalculated based on signups in a real app
      participantVacancy: activity.participantVacancy,
      volunteerVacancy: activity.volunteerVacancy,
      ...
      repeat: formData.repeat ? formData.repeatFrequency : undefined,
