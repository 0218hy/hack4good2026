      ...
      <div className="fixed inset-0 backdrop-blur-sm bg-white/30 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full">
          <div className="border-b border-gray-200 p-6 flex justify-between items-center">
            <h2 className="text-2xl font-bold text-gray-900">Confirm Sign-up 确认报名</h2>
            <button
              onClick={onClose}
          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                />
                <span className="text-lg font-semibold text-gray-900">Caregiver accompanying? 护理人员陪同?</span>
              </label>
                ...
                <div className="ml-8 space-y-4 pt-4">
                  <div>
                    <label htmlFor="caregiverName" className="block text-base font-semibold text-gray-700 mb-2">
                      Caregiver Name (Optional) 护理人员姓名（可选）
                    </label>
                    <input
                      type="text"
                      id="caregiverName"
                  ...
                  <div>
                    <label htmlFor="caregiverContact" className="block text-base font-semibold text-gray-700 mb-2">
                      Caregiver Contact Number (Optional) 护理人员联系电话（可选）
                    </label>
                    <input
                      type="tel"
                      id="caregiverContact"
