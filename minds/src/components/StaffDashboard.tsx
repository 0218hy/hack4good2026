...
import { Activity as ActivityIcon, LogOut, Calendar, PlusCircle, Users, List, ChevronLeft, ChevronRight, UserPlus, BarChart3 } from 'lucide-react';
...
export default function StaffDashboard({ activities, setActivities, baseActivities, setBaseActivities }: StaffDashboardProps) {
  ...
  const [activeView, setActiveView] = useState<'calendar' | 'list' | 'create' | 'participants' | 'volunteers' | 'createAccount' | 'statistics'>('calendar');
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex h-[calc(100vh-104px)]">
        ...
        <main className="flex-1 overflow-y-auto p-10">
          ...
          {activeView === 'statistics' && (
            <StaffStatistics activities={activities} />
          )}
        </main>
      </div>
